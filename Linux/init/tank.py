...
class Tank(Vehicule):
    def __init__(self, size : tuple = (1280, 720)):
        ...
        tank_image, tank_rect = add_asset('Linux/assets/tank.png')
        parts.append([tank_image, tank_rect, False])

        tank2_image, tank2_rect = add_asset('Linux/assets/revert_tank.png')
        tank2_rect.center = tank_rect.center
        parts.append([tank2_image, tank2_rect, False])

        tank3_image, tank3_rect = add_asset('Linux/assets/shooting_tank.png')
        parts.append([tank3_image, tank3_rect, False])

        tank4_image, tank4_rect = add_asset('Linux/assets/revert_shooting_tank.png')
...
class Pew():
    def __init__(self, tank : Tank):
        ...
        rightshot_image, rightshot_rect = add_asset('Linux/assets/tank_pew.png')
        rightshot_rect.center = (self.tank.get_left(), self.tank.get_top())
        parts.append([rightshot_image, rightshot_rect, False])

        leftshot_image, leftshot_rect = add_asset('Linux/assets/revert_tank_pew.png')
