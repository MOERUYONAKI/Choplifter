...
class Jet(Vehicule):
    def __init__(self, size : tuple = (1280, 720)):
        ...
        jet_image, jet_rect = add_asset('Linux/assets/jet.png')
        parts.append([jet_image, jet_rect, False])

        jet2_image, jet2_rect = add_asset('Linux/assets/revert_jet.png')
...
class Pew():
    def __init__(self, jet : Jet):
        ...
        rightshot_image, rightshot_rect = add_asset('Linux/assets/jet_pew.png')
        rightshot_rect.center = (self.jet.get_left(), self.jet.get_top())
        parts.append([rightshot_image, rightshot_rect, False])

        leftshot_image, leftshot_rect = add_asset('Linux/assets/revert_jet_pew.png')
