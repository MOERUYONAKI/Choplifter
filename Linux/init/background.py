...
class Background():
    def __init__(self, size : tuple = (1280, 720)):
        ...
        base_bg_image = py.image.load('Linux/assets/bg1.png').convert_alpha()
        ...
        part1_bg_image = py.image.load('Linux/assets/bg2.png').convert_alpha()
        ...
        part2_bg_image = py.image.load('Linux/assets/bg3.png').convert_alpha()
