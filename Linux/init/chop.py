...
class Chop(Vehicule):
    def __init__(self, size : tuple = (1280, 720)):
        ...
        chop_image, chop_rect = add_asset('Linux/assets/helicopter.png')
        parts.append([chop_image, chop_rect, False])

        chop2_image, chop2_rect = add_asset('Linux/assets/revert_helicopter.png')
        chop2_rect.center = chop_rect.center
        parts.append([chop2_image, chop2_rect, False])

        chop3_image, chop3_rect = add_asset('Linux/assets/helico_ball.png')
        chop3_rect.center = chop_rect.center
        parts.append([chop3_image, chop3_rect, False])

        chop4_image, chop4_rect = add_asset('Linux/assets/grounded_helicopter.png')
