...
def bases_init(size : tuple, bases_numbers : int):
    ...
    for i in range(bases_numbers):
        # Création des bases
        bases.append([py.image.load('Linux/assets/basement.png').convert_alpha()])
        ...
        for j in range(0, random.randint(12, 32), 2):
            ...
            hostages[i].append([py.image.load('Linux/assets/hostage.png').convert_alpha()])
            hostages[i].append([py.image.load('Linux/assets/revert_hostage.png').convert_alpha()])
