...
python3 -m PyInstaller --onefile --add-data "assets\\Fonts\\amd64_microsoft-windows-f..ruetype-comicsansms_31bf3856ad364e35_10.0.22621.1_none_3deaef772e20c404\\comic.ttf" --add-data "assets\\Songs\\Audiomachine - By the Hand of the Mortal.mp3" --add-data "assets\\menu_bg.jpg" --add-data "assets\\choplifter_txt.png" --add-data "assets\\play_txt.png" --add-data "assets\\quit_txt.png" choplifter_survival.py
